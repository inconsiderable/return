    ...
    <>
      <section className="ion-padding">
        <IonInput
          ...
          label="Passphrase"
          placeholder="What is your heart's purpose?"
...
export const MirrorHeart = ({
  ...
  return (
    <IonCard>
      <IonCardHeader>
        <IonCardSubtitle>Mirror heart to continue</IonCardSubtitle>
      </IonCardHeader>
      <IonCardContent>
        <IonText class="ion-text-center" color="danger">
          <p>A passphrase is required to mirror a heart.</p>
